const numberOfPairsInput = document.querySelector('#number-of-pairs');
const btnPlay = document.querySelector('.lets-play');
...
btnPlay.addEventListener('click', () => {
    const numberOfPairs = +(numberOfPairsInput.value);

    if (numberOfPairs === 6 || numberOfPairs === 12 || numberOfPairs === 18) {

        console.log(numberOfPairs); // log 
        amount = numberOfPairs;
        ...
        board.style.gridTemplateColumns = `repeat(6, 2fr)`;
